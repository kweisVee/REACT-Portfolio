...
import WorkImg from '../../images/workers.jpg'
...
const Projects = () => {
    ...
    return (
        ...
        <ProjectsContainer id="projects">
            <ProjectImg alt="ProjectImg" src={WorkImg} />
            <ProjectsTitleContainer>
                {/* <ProjectsTitle>My Projects</ProjectsTitle> */}
                <ProjectsWrapper>
                    <ProjectsCard
                        onClick={() => handleClick('HollywoodTheater')}
                    >
                        <ProjectName>HOLLYWOOD THEATER</ProjectName>
                        <ProjectsIcon src={Icon1} />
                        <ProjectDesc>
                            A booking reservation app using Mongodb, Express.js,
                            React.js, and Node.js.{' '}
                        </ProjectDesc>
                    </ProjectsCard>
                    <ProjectsCard
                        onClick={() => handleClick('iOS-Mood-Tracker')}
                    >
                        <ProjectName>MOOD TRACKER</ProjectName>
                        <ProjectsIcon src={Icon2} />
                        <ProjectDesc>
                            An iOs project built with Swift, SwiftUI, Texture,
                    ...
                    <ProjectsCard onClick={() => handleClick('Treater')}>
                        ...
                        <ProjectDesc>
                            A social media web application like Twitter built
                            with the Django framework, HTML, CSS, Javascript,
                            and SQLite.
                        </ProjectDesc>
                    </ProjectsCard>
                    <ProjectsCard onClick={() => handleClick('s12g9')}>
                        ...
                        <ProjectDesc>
                            A hotel booking system built with Node.js,
                            Express.js, HTML, CSS, Javascript, and MongoDB.
                        </ProjectDesc>
                    </ProjectsCard>
                    <ProjectsCard
                        onClick={() => handleClick('MOBDEVE-S15-Group-9')}
                    >
                        <ProjectName>BOOKBAY</ProjectName>
                        <ProjectsIcon src={Icon5} />
                        <ProjectDesc>
                            An online bookstore android application built with
                            Java, and MongoDB.
                        </ProjectDesc>
                    </ProjectsCard>
                </ProjectsWrapper>
